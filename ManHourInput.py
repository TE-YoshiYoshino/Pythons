...
#    label_sub.pack()
    ...
    item2=tk.Label(sub_win,text='2個目')
    ...
    item3=tk.Label(sub_win,text='3個目')
    ...
    item4=tk.Label(sub_win,text='4個目')
    ...
    btn_register = tk.Button(sub_win, text='登録', command=lambda:ctrl_sub_win(sub_win,key,entry_item1))
